...
import (
	...
	. "mongorsync-1.1/smartystreets/assertions/internal/ogletest"
)
...
func (t *CreateMockTest) SetUpTestSuite() {
	...
	cmd := exec.Command("go", "build", "-o", createmockPath, "mongorsync-1.1/smartystreets/assertions/internal/oglemock/createmock")
...
func (t *CreateMockTest) runCompilationTest(createmockArgs ...string) {
	...
	buildPkg, err := build.Import("mongorsync-1.1/smartystreets/assertions/internal/oglemock", "", build.FindOnly)
	AssertEq(nil, err)
...
func (t *CreateMockTest) GCSBucket() {
	t.runGoldenTest(
		"gcs_bucket",
		0,
		"mongorsync-1.1/smartystreets/assertions/internal/oglemock/createmock/testdata/gcs",
		"Bucket")
}
...
func (t *CreateMockTest) ComplicatedSamplePackage() {
	t.runCompilationTest(
		"mongorsync-1.1/smartystreets/assertions/internal/oglemock/generate/testdata/complicated_pkg",
		"ComplicatedThing")
}

func (t *CreateMockTest) RenamedSamplePackage() {
	t.runCompilationTest(
		"mongorsync-1.1/smartystreets/assertions/internal/oglemock/generate/testdata/renamed_pkg",
		"SomeInterface")
}
