...
import (
	...
	"mongorsync-1.1/smartystreets/assertions/internal/reqtrace"
)
...
func formatPanicStack() string {
	...
	for i := initialSkip; ; i++ {
		...
		if funcName == "mongorsync-1.1/smartystreets/assertions/internal/ogletest.runTestMethod" ||
			funcName == "mongorsync-1.1/smartystreets/assertions/internal/ogletest.runWithProtection" {
			break
		}
