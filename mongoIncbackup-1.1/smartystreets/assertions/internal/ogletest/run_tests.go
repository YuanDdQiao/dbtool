...
import (
	...
	"mongoIncbackup-1.1/smartystreets/assertions/internal/reqtrace"
)
...
func formatPanicStack() string {
	...
	for i := initialSkip; ; i++ {
		...
		if funcName == "mongoIncbackup-1.1/smartystreets/assertions/internal/ogletest.runTestMethod" ||
			funcName == "mongoIncbackup-1.1/smartystreets/assertions/internal/ogletest.runWithProtection" {
			break
		}
