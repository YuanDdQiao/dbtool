...
const ogletestPkg = "mongoIncbackup-1.1/smartystreets/assertions/internal/ogletest"
...
func installLocalPackages() error {
	cmd := exec.Command(
		...
		"install",
		ogletestPkg,
		"mongoIncbackup-1.1/smartystreets/assertions/internal/oglemock",
		"mongoIncbackup-1.1/smartystreets/assertions/internal/ogletest/test_cases/mock_image")
...
func createTempPackageDir(caseName string) (dir, pkg string) {
	...
	pkg = path.Join("mongoIncbackup-1.1/smartystreets/assertions/internal/ogletest", dir[len(ogletestPkgDir):])
	return
}
