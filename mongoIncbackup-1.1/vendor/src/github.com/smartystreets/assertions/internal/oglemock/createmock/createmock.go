...
import (
	...
	_ "mongoIncbackup-1.1/smartystreets/assertions/internal/oglemock/generate"
)
...
func run() error {
	...
	arg.Imports["generate"] = "mongoIncbackup-1.1/smartystreets/assertions/internal/oglemock/generate"
	arg.Imports["log"] = "log"
	arg.Imports["os"] = "os"
