...
import (
	...
	"mongoIncbackup-1.1/smartystreets/goconvey/convey/reporting"
	"mongoIncbackup-1.1/smartystreets/goconvey/web/server/contract"
)
...
var expected_NoGoFiles = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey",
...
var expected_NoTestFunctions = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey/scripts",
...
var expected_BuildFailed_InvalidPackageDeclaration = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey/examples",
...
./t_test.go:23: import "mongoIncbackup-1.1/smartystreets/goconvey/t" while compiling that package (import cycle)
FAIL	github.com/smartystreets/goconvey/t [build failed]
`

var expected_BuildFailed_ImportCycle = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey/t",
	Outcome:     contract.BuildFailure,
...
var expectedOldSchool_Passes = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey/webserver/examples",
	Elapsed:     0.018,
	Coverage:    100,
...
var expectedGoConvey_WithRandomOutput = contract.PackageResult{
	PackageName: "mongoIncbackup-1.1/smartystreets/goconvey/web/server/testing",
	Elapsed:     0.024,
	Outcome:     contract.Passed,
	Coverage:    45.0,
	TestResults: []contract.TestResult{
